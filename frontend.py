...
tasks_example = [("do this",True,"date"),("do this",True,"date"),("do this",True,"date"),("do this",True,"date")]
...
class MainWindow(tk.Frame):
    ...
    def delivery_info(self,pos_x,pos_y):
        ...
        """
        self.label_frame_delivery = tk.LabelFrame(self.master,text="Delivery Info",height="350",width="300")
        self.label_frame_delivery.place(x=pos_x,y=pos_y)
        self.deliver_address = tk.Label(self.label_frame_delivery,text="Delivery Address")
        self.deliver_address.grid(column=0,row=0)
        self.entry_del_address = tk.Entry(self.label_frame_delivery,width="25")
    ...
    def draw_info(self,name,pos_x,pos_y,labels=True):
        ...
        """
        label_frame = tk.LabelFrame(self.master,text="{} Info".format(name),height="350",width="300")
        ...
        name_label = tk.Label(label_frame,text="{} Name".format(name),font=BASICFONT)
        ...
        if labels:
            ...
            name = tk.Label(label_frame,text="Name")
            name.grid(column=1,row=1)

            address = tk.Label(label_frame,text="o")
            address.grid(column=1,row=2)
        


            phone = tk.Label(label_frame,text="88005553535")
            phone.grid(column=1,row=4)

            contact = tk.Label(label_frame,text="Some Name")
            ...
            if name=="Customer":
                address_ship = tk.Entry(label_frame)
                address_ship.grid(column=1,row=3)
    ...
    def draw_dates(self,pos_x,pos_y):
        ...
        self.entry_client = tk.Label(self.label_frame_dates,text="2019/03/03",font=ENTRYFONT)
        self.entry_client.grid(column = 1,row = 0,sticky="w")

        self.entry_required = tk.Label(self.label_frame_dates,text="2019/03/03",font=ENTRYFONT)
        self.entry_required.grid(column = 1,row = 1,sticky="w")

        self.entry_ship = tk.Label(self.label_frame_dates,text="2019/03/03",font=ENTRYFONT)
    ...
    def draw_tasks(self,length,pos_x,pos_y):
        ...
        """
        self.tasks = []
        self.label_frame_tasks = tk.LabelFrame(text="Tasks",height="130",width="300")
